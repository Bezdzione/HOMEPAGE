...
const setGreenColor = () => {
    clickableArea.style.backgroundColor = "#94d1be";
...
const displayReactionTime = (rt) => {
    ...
    message.innerHTML = `<div class='reaction-time-text'>${rt} ms</div>Paspauskite, kad tęsti.`;
    greenDisplayed = false;
...
const displayTooSoon = () => {
    clickableArea.style.backgroundColor = "#faf0ca";
    message.innerHTML = "Palaukite žalios spalvos. Paspauskite, kad bandyti dar kartą."
    message.style.color = "#111";
    waitingForStart = true;
    clearTimeout (timer);
}
